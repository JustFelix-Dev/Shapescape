...
const FirstSection = () => {
  ...
  if (openMenu) {
    return (
      <div className="absolute h-[100vh] flex flex-col gap-12 inset-0 z-[999] bg-based px-6 sm:px-0">
        <nav className="flex h-[68px] justify-between items-center">
          <div>
            <img
              src={shapescapeLogo}
              className="h-[22px]"
        ...
        <div className="text-white flex flex-col gap-6 items-center font-semibold text-[24px]">
          ...
          <nav className="flex justify-between items-center">
            ...
            <ul className=" nav-list flex gap-4">
              <li className="relative flex items-center justify-center text-white text-[16px] p-[20px]">
                Education{" "}
                <i className="absolute bottom-2 fa-solid fa-square"></i>
              </li>
              <li className="relative flex items-center justify-center text-white text-[16px] p-[20px]">
